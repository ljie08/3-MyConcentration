...
- (void)circleprogressAction {
    ...
    //20分钟 1200秒
    NSLog(@"allSecond - %f",self.allSecond/1200.0);
    //进度百分比再倒计时的时候设置
//    _progress.percent = 1-self.allSecond/1200.0;
}
